...
#     net = models.load_model(os.path.join(app.config['default'].UPLOAD_FOLDER, model))
#     cls_list = ['Cushion', 'desk', 'footstool', 'frame', 'lamps', 'mugs', 'vasesbowl']
#
#     # 辨識一張圖
#     # img = Image.open(os.path.join("C:/Users/TibeMe_user/Desktop/FindGoods-web/static/img/uploads/mugs.jpg"))
...
# if __name__ == '__main__':
    ...
    # print(namelist)
    # print(type(models))
    # "C:/Users/TibeMe_user/Desktop/FindGoods-web/static/img/uploads/model-resnet50-final.h5"
    # t = models.load_model("C:/Users/TibeMe_user/Desktop/FindGoods-web/static/img/uploads/model-resnet50-final.h5")
    # print(type(t))
    # print(t)
